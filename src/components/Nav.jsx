...
const Nav = () => {
  return (
    <nav className="bg-white/20 backdrop-blur-lg border-b border-white/20 shadow-sm">
      <div className="mx-auto px-4 sm:px-4 md:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4 sm:py-3 md:py-4">
          {/* Logo/Brand */}
          ...
          <ScrollAnimation animation="fadeInRight" delay={0.2}>
            <div>
              <a 
                ...
                className="rounded-full text-white font-medium hover:scale-105 transition-all duration-300 px-4 py-2 sm:px-3 sm:py-1.5 md:px-4 md:py-2 lg:px-6 lg:py-2.5 text-sm sm:text-sm md:text-base backdrop-blur-sm shadow-lg border border-white/20 inline-block"
